...
# Edit this set to add more invalid TLDs or in case of false positives
# TODO: Migrate to a settings file for import and configurable management?
INVALID_TLD: set[str] = {
    "doc",
    "xls",
    "xlsb",
...
def is_bogon(
    ip: int | str | bytes | ipaddress.IPv4Address | ipaddress.IPv6Address,
) -> bool:
